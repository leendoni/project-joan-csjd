								...
								<div class="menu-item-collapse">
									<div class="min-h-0">
										...
										<a
											...
											class="menu-item menu-active ml-6">Enrollments</a>
					...
					<div class="form-group flex flex-col lg:flex-row w-full">
						...
						<div class="form-field w-full">
							...
							<select
								...
								{#each departmentOptions as department (department)}
						...
						<div class="form-field w-full">
							...
							<select
								...
								{#if selectedUserData.userDP}
									{#each yearLevelOptions[selectedUserData.userDP] as yearLevel (yearLevel)}
						...
						<div class="form-field w-full">
							...
							<select
								...
								{#if selectedUserData.userYR}
									{#each filteredSections as section (section)}
										<option value={section.sectNM}>{section.sectNM}</option>
									{/each}
								{:else}
