<script>
	...
	async function fetchUsers() {
		try {
			...
			// if (selectedStatus) {
			// 	users = users.filter((user) => user.userST === selectedStatus);
			// }
			...
			switch (selectedFilter) {
				...
				case 'Activated':
					limitedUsers = users
						.filter((user) => user.userST.toLowerCase() === 'activated')
						.slice(currentPage * 6, (currentPage + 1) * 6);
					break;
				case 'Disabled':
					limitedUsers = users
						.filter((user) => user.userST.toLowerCase() === 'disabled')
						.slice(currentPage * 6, (currentPage + 1) * 6);
					break;
				case 'Students Only':
					limitedUsers = users
						.filter((user) => user.userCL.toLowerCase() === 'student')
						.slice(currentPage * 6, (currentPage + 1) * 6);
					break;
				case 'Employees Only':
					limitedUsers = users
...
<div class="flex flex-col w-screen h-screen overflow-x-hidden bg-border">
							...
							<li>
								...
								<div class="menu-item-collapse">
									<div class="min-h-0">
										<a
											href="/manage/users"
											class="menu-item menu-active ml-6">User Management</a>
										<a
	...
	{#if modlST}
		<div
			...
			<div class="flex flex-col">
				<h1 class="text-xl font-semibold">User Masterlist</h1>
				<p class="text-xs">Below is the list of all user accounts registered on the system.</p>
			</div>
					...
					<div class="dropdown dropdown-hover">
						...
						<div class="dropdown-menu dropdown-menu-right-bottom ml-2">
							<p
								...
								on:click={() => filterUsers('Pre-Registered')}>
								Pre-Registered
							</p>
							<p
								class="dropdown-item text-sm"
							...
							<p
								class="dropdown-item text-sm"
								on:click={() => filterUsers('Activated')}>
								Activated
							</p>
							<p
								class="dropdown-item text-sm"
								on:click={() => filterUsers('Disabled')}>
								Disabled
							</p>
							<div class="divider my-0" />
							<p
								class="dropdown-item text-sm"
								on:click={() => filterUsers('Students Only')}>
								Students Only
							</p>
							<p
								class="dropdown-item text-sm"
								on:click={() => filterUsers('Employees Only')}>
								Employees Only
							</p>
							<div class="divider my-0" />
							<p
								class="dropdown-item text-sm"
								on:click={() => filterUsers(null)}>
								Clear Filter
							</p>
						</div>
					</div>
			...
			<div class="flex flex-row w-full gap-2">
				{#if !isCreating && !isSelecting && !isEditing}
					<button
						...
						on:click={() => (isCreating = true)}>Create New</button>
				{:else if isCreating}
					<button
			...
			<div class="divider my-0" />
			<div class="flex flex-col">
				<h1 class="text-xl font-semibold">User Information</h1>
				<p class="text-xs">Select a user to load his/her information.</p>
			</div>
			{#if isEditing && !isCreating}
				<div class="flex flex-row w-auto">
					<h1 class="text-sm font-semibold underline">Account Information</h1>
				</div>
				...
				<div class="form-group flex flex-col lg:flex-row w-full">
					<div class="form-field w-full">
						...
						<input
							...
							readonly
							bind:value={selectedUserData.userUN} />
					</div>
					<div class="form-field w-full">
						<label
							for="userPW"
						...
						<button
							class="btn btn-outline-primary"
							disabled={selectedUserData.userFP === false}>Reset Password</button>
					</div>
				</div>
				{#if selectedUserData.userCL == 'Student'}
					<div class="flex flex-col">
				...
				<div class="form-group flex lg:flex-row">
					...
					<div class="form-field w-full">
						...
						<input
							id="userCN"
							class="input max-w-full"
							bind:value={selectedUserData.userCN} />
					</div>
					<div class="form-field w-full">
						<label
							for="userEC"
						...
						<input
							id="userEC"
							class="input max-w-full"
							bind:value={selectedUserData.userEC} />
					</div>
				</div>
				<div class="form-group flex lg:flex-row">
					<div class="form-field w-full">
						...
						<input
							id="userAD"
							class="input max-w-full"
							bind:value={selectedUserData.userAD} />
					</div>
				</div>
				{#if selectedUserData.userCL != 'Student'}
					<div class="form-group flex lg:flex-row">
						<div class="form-field w-full">
							...
							<input
								id="userCP"
								class="input max-w-full"
								bind:value={selectedUserData.userCP} />
						</div>
						<div class="form-field w-full">
							<label
								for="userCR"
								class="form-label">Contact Relation</label>
							<input
								id="userCR"
								class="input max-w-full"
								bind:value={selectedUserData.userCR} />
						</div>
					</div>
				{:else}
					<div class="form-group flex lg:flex-row">
						<div class="form-field w-full">
							...
							<input
								id="userMA"
								class="input max-w-full"
								bind:value={selectedUserData.userMA} />
							<div class="flex">
								<div class="flex h-auto items-center gap-2">
									<input
										...
										name="contactPerson"
										id="motherRadio"
										checked={selectedUserData.userCR === 'Mother'} />
						...
						<div class="form-field w-full">
							...
							<input
								id="userFA"
								class="input max-w-full"
								bind:value={selectedUserData.userFA} />
							<div class="flex">
								<div class="flex h-auto items-center gap-2">
									<input
										type="radio"
										...
										name="contactPerson"
										id="fatherRadio"
										checked={selectedUserData.userCR === 'Father'} />
									<p class="text-sm">set as Contact Person</p>
								</div>
							</div>
						</div>
						<div class="form-field w-full">
							...
							<input
								id="userGA"
								class="input max-w-full"
								bind:value={selectedUserData.userGA} />
							<div class="flex">
								<div class="flex h-auto items-center gap-2">
									<input
										type="radio"
										...
										name="contactPerson"
										id="guardianRadio"
										checked={selectedUserData.userCR === 'Guardian'} />
									<p class="text-sm">set as Contact Person</p>
								</div>
							</div>
						</div>
			...
			{#if isSelecting && !isCreating}
				...
				<div class="form-group flex flex-col lg:flex-row w-full">
					...
					<div class="form-field w-full">
						...
						<button
							disabled
							class="btn btn-outline-primary">Reset Password</button>
					</div>
				</div>
				{#if selectedUserData.userCL == 'Student'}
					<div class="flex flex-col">
