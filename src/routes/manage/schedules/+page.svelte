<script>
			...
			switch (selectedFilter) {
				case 'Active':
					limitedSections = sections
						.filter((section) => section.sectST.toLowerCase() === 'active')
						.slice(currentPage * 6, (currentPage + 1) * 6);
					break;
				case 'Archived':
					limitedSections = sections
						.filter((section) => section.sectST.toLowerCase() === 'archived')
						.slice(currentPage * 6, (currentPage + 1) * 6);
					break;
				case 'Clear Filter':
					limitedSections = sections.slice(currentPage * 6, (currentPage + 1) * 6);
					break;
				default:
					limitedSections = sections.slice(currentPage * 6, (currentPage + 1) * 6);
			}
	...
	function updateLimitedSections() {
		switch (selectedFilter) {
			case 'Active':
				limitedSections = sections
					.filter((section) => section.sectST.toLowerCase() === 'active')
	...
	async function fetchSubjects() {
		try {
			...
			const subjectSelect = document.getElementById('subjTC');
			...
			if (subjectSelect) {
				...
				subjects.forEach((subject) => {
					...
					option.textContent = subject.subjNM;
	...
	function subjectIsAvailable(subjectID, subjectIndex) {
		for (let i = 1; i < subjectIndex; i++) {
			if (selectedSubjects[i] === subjectID) {
				return false;
			}
		}
		return true;
	...
	let subj1, subj2, subj3, subj4, subj5, subj6, subj7, subj8, subj9, subj10, subj11, subj12;
	...
	function setSubjects() {
		...
		schedules = {
			schedG01: [
				{ time: '06:45 - 07:15', data: ['', '', '', '', ''] },
				{ time: '07:15 - 08:00', data: ['', '', '', '', ''] },
				{
					time: '08:00 - 08:45',
					data: [`${subj1}`, `${subj8}`, `${subj7}`, `${subj10}`, `${subj9}`]
				},
				{
					time: '08:45 - 09:30',
					data: [`${subj2}`, `${subj1}`, `${subj8}`, `${subj11}`, `${subj10}`]
				},
				{ time: '09:30 - 10:00', data: ['', '', '', '', ''] },
				{
					time: '10:00 - 10:45',
					data: [`${subj3}`, `${subj2}`, `${subj1}`, `${subj12}`, `${subj11}`]
				},
				{
					time: '10:45 - 11:30',
					data: [`${subj4}`, `${subj3}`, `${subj2}`, `${subj1}`, `${subj12}`]
				},
				{ time: '11:30 - 12:30', data: ['', '', '', '', ''] },
				{
					time: '12:30 - 01:15',
					data: [`${subj5}`, `${subj4}`, `${subj3}`, `${subj2}`, `${subj1}`]
				},
				{
					time: '01:15 - 02:00',
					data: [`${subj6}`, `${subj5}`, `${subj4}`, `${subj3}`, `${subj2}`]
				},
				{ time: '02:00 - 02:30', data: ['', '', '', '', ''] },
				{
					time: '02:30 - 03:15',
					data: [`${subj7}`, `${subj6}`, `${subj5}`, `${subj4}`, `${subj3}`]
				},
				{
					time: '03:15 - 04:00',
					data: [`${subj8}`, `${subj7}`, `${subj6}`, `${subj9}`, `${subj4}`]
				},
				{ time: '04:30 - 05:15', data: ['', '', '', '', ''] }
			],
			...
			schedG02: [
				...
				{
					time: '08:00 - 08:45',
					data: [`${subj8}`, `${subj7}`, `${subj10}`, `${subj9}`, `${subj1}`]
				},
				{
					time: '08:45 - 09:30',
					data: [`${subj1}`, `${subj8}`, `${subj11}`, `${subj10}`, `${subj2}`]
				},
				{ time: '09:30 - 10:00', data: ['', '', '', '', ''] },
				{
					time: '10:00 - 10:45',
					data: [`${subj2}`, `${subj1}`, `${subj12}`, `${subj11}`, `${subj3}`]
				},
				{
					time: '10:45 - 11:30',
					data: [`${subj3}`, `${subj2}`, `${subj1}`, `${subj12}`, `${subj4}`]
				},
				{ time: '11:30 - 12:30', data: ['', '', '', '', ''] },
				{
					time: '12:30 - 01:15',
					data: [`${subj4}`, `${subj3}`, `${subj2}`, `${subj1}`, `${subj5}`]
				},
				{
					time: '01:15 - 02:00',
					data: [`${subj5}`, `${subj4}`, `${subj3}`, `${subj2}`, `${subj6}`]
				},
				{ time: '02:00 - 02:30', data: ['', '', '', '', ''] },
				{
					time: '02:30 - 03:15',
					data: [`${subj6}`, `${subj5}`, `${subj4}`, `${subj3}`, `${subj7}`]
				},
				{
					time: '03:15 - 04:00',
					data: [`${subj7}`, `${subj6}`, `${subj9}`, `${subj4}`, `${subj8}`]
				},
				{ time: '04:30 - 05:15', data: ['', '', '', '', ''] }
			],
			...
			schedG03: [
				...
				{
					time: '08:00 - 08:45',
					data: [`${subj7}`, `${subj10}`, `${subj9}`, `${subj1}`, `${subj8}`]
				},
				{
					time: '08:45 - 09:30',
					data: [`${subj8}`, `${subj11}`, `${subj10}`, `${subj2}`, `${subj1}`]
				},
				{ time: '09:30 - 10:00', data: ['', '', '', '', ''] },
				{
					time: '10:00 - 10:45',
					data: [`${subj1}`, `${subj12}`, `${subj11}`, `${subj3}`, `${subj2}`]
				},
				{
					time: '10:45 - 11:30',
					data: [`${subj2}`, `${subj1}`, `${subj12}`, `${subj4}`, `${subj3}`]
				},
				{ time: '11:30 - 12:30', data: ['', '', '', '', ''] },
				{
					time: '12:30 - 01:15',
					data: [`${subj3}`, `${subj2}`, `${subj1}`, `${subj5}`, `${subj4}`]
				},
				{
					time: '01:15 - 02:00',
					data: [`${subj4}`, `${subj3}`, `${subj2}`, `${subj6}`, `${subj5}`]
				},
				{ time: '02:00 - 02:30', data: ['', '', '', '', ''] },
				{
					time: '02:30 - 03:15',
					data: [`${subj5}`, `${subj4}`, `${subj3}`, `${subj7}`, `${subj6}`]
				},
				{
					time: '03:15 - 04:00',
					data: [`${subj6}`, `${subj9}`, `${subj4}`, `${subj8}`, `${subj7}`]
				},
				{ time: '04:30 - 05:15', data: ['', '', '', '', ''] }
			],
			...
			schedG04: [
				...
				{
					time: '08:00 - 08:45',
					data: [`${subj10}`, `${subj9}`, `${subj1}`, `${subj8}`, `${subj7}`]
				},
				{
					time: '08:45 - 09:30',
					data: [`${subj11}`, `${subj10}`, `${subj2}`, `${subj1}`, `${subj8}`]
				},
				{ time: '09:30 - 10:00', data: ['', '', '', '', ''] },
				{
					time: '10:00 - 10:45',
					data: [`${subj12}`, `${subj11}`, `${subj3}`, `${subj2}`, `${subj1}`]
				},
				{
					time: '10:45 - 11:30',
					data: [`${subj1}`, `${subj12}`, `${subj4}`, `${subj3}`, `${subj2}`]
				},
				{ time: '11:30 - 12:30', data: ['', '', '', '', ''] },
				{
					time: '12:30 - 01:15',
					data: [`${subj2}`, `${subj1}`, `${subj5}`, `${subj4}`, `${subj3}`]
				},
				{
					time: '01:15 - 02:00',
					data: [`${subj3}`, `${subj2}`, `${subj6}`, `${subj5}`, `${subj4}`]
				},
				{ time: '02:00 - 02:30', data: ['', '', '', '', ''] },
				{
					time: '02:30 - 03:15',
					data: [`${subj4}`, `${subj3}`, `${subj7}`, `${subj6}`, `${subj5}`]
				},
				{
					time: '03:15 - 04:00',
					data: [`${subj9}`, `${subj4}`, `${subj8}`, `${subj7}`, `${subj6}`]
				},
				{ time: '04:30 - 05:15', data: ['', '', '', '', ''] }
			],
			...
			schedG05: [
				...
				{
					time: '08:00 - 08:45',
					data: [`${subj9}`, `${subj1}`, `${subj8}`, `${subj7}`, `${subj10}`]
				},
				{
					time: '08:45 - 09:30',
					data: [`${subj10}`, `${subj2}`, `${subj1}`, `${subj8}`, `${subj11}`]
				},
				{ time: '09:30 - 10:00', data: ['', '', '', '', ''] },
				{
					time: '10:00 - 10:45',
					data: [`${subj11}`, `${subj3}`, `${subj2}`, `${subj1}`, `${subj12}`]
				},
				{
					time: '10:45 - 11:30',
					data: [`${subj12}`, `${subj4}`, `${subj3}`, `${subj2}`, `${subj1}`]
				},
				{ time: '11:30 - 12:30', data: ['', '', '', '', ''] },
				{
					time: '12:30 - 01:15',
					data: [`${subj1}`, `${subj5}`, `${subj4}`, `${subj3}`, `${subj2}`]
				},
				{
					time: '01:15 - 02:00',
					data: [`${subj2}`, `${subj6}`, `${subj5}`, `${subj4}`, `${subj3}`]
				},
				{ time: '02:00 - 02:30', data: ['', '', '', '', ''] },
				{
					time: '02:30 - 03:15',
					data: [`${subj3}`, `${subj7}`, `${subj6}`, `${subj5}`, `${subj4}`]
				},
				{
					time: '03:15 - 04:00',
					data: [`${subj4}`, `${subj8}`, `${subj7}`, `${subj6}`, `${subj9}`]
				},
				{ time: '04:30 - 05:15', data: ['', '', '', '', ''] }
			],
			...
			schedG06: [
				...
				{
					time: '08:00 - 08:45',
					data: [`${subj4}`, `${subj3}`, `${subj2}`, `${subj4}`, `${subj3}`]
				},
				{
					time: '08:45 - 09:30',
					data: [`${subj5}`, `${subj4}`, `${subj3}`, `${subj9}`, `${subj4}`]
				},
				{ time: '09:30 - 10:00', data: ['', '', '', '', ''] },
				{
					time: '10:00 - 10:45',
					data: [`${subj6}`, `${subj5}`, `${subj4}`, `${subj10}`, `${subj9}`]
				},
				{
					time: '10:45 - 11:30',
					data: [`${subj7}`, `${subj6}`, `${subj5}`, `${subj11}`, `${subj10}`]
				},
				{ time: '11:30 - 12:30', data: ['', '', '', '', ''] },
				{
					time: '12:30 - 01:15',
					data: [`${subj8}`, `${subj7}`, `${subj6}`, `${subj12}`, `${subj11}`]
				},
				{
					time: '01:15 - 02:00',
					data: [`${subj1}`, `${subj8}`, `${subj7}`, `${subj1}`, `${subj12}`]
				},
				{ time: '02:00 - 02:30', data: ['', '', '', '', ''] },
				{
					time: '02:30 - 03:15',
					data: [`${subj2}`, `${subj1}`, `${subj8}`, `${subj2}`, `${subj1}`]
				},
				{
					time: '03:15 - 04:00',
					data: [`${subj3}`, `${subj2}`, `${subj1}`, `${subj3}`, `${subj2}`]
				},
				{ time: '04:30 - 05:15', data: ['', '', '', '', ''] }
			],
			...
			schedG07: [
				{ time: '06:45 - 07:15', data: ['', '', '', '', ''] },
				{ time: '07:15 - 08:15', data: [`${subj1}`, `${subj9}`, `${subj8}`, `${subj10}`, ''] },
				{
					time: '08:15 - 09:15',
					data: [`${subj2}`, `${subj1}`, `${subj9}`, `${subj11}`, `${subj10}`]
				},
				{
					time: '09:15 - 10:15',
					data: [`${subj3}`, `${subj2}`, `${subj1}`, `${subj12}`, `${subj11}`]
				},
				{ time: '10:15 - 10:30', data: ['', '', '', '', ''] },
				{
					time: '10:30 - 11:30',
					data: [`${subj4}`, `${subj3}`, `${subj2}`, `${subj1}`, `${subj12}`]
				},
				...
				{ time: '03:15 - 03:30', data: ['', '', '', '', ''] },
				{
					time: '03:30 - 04:30',
					data: [`${subj8}`, `${subj7}`, `${subj6}`, `${subj5}`, `${subj4}`]
				},
				{ time: '04:30 - 05:30', data: [`${subj9}`, `${subj8}`, `${subj7}`, '', `${subj5}`] }
			],

			schedG08: [
				{ time: '06:45 - 07:15', data: ['', '', '', '', ''] },
				{ time: '07:15 - 08:15', data: [`${subj9}`, `${subj8}`, `${subj10}`, '', `${subj1}`] },
				{
					time: '08:15 - 09:15',
					data: [`${subj1}`, `${subj9}`, `${subj11}`, `${subj10}`, `${subj2}`]
				},
				{
					time: '09:15 - 10:15',
					data: [`${subj2}`, `${subj1}`, `${subj12}`, `${subj11}`, `${subj3}`]
				...
				{
					time: '03:30 - 04:30',
					data: [`${subj7}`, `${subj6}`, `${subj5}`, `${subj4}`, `${subj8}`]
				},
				{ time: '04:30 - 05:30', data: [`${subj8}`, `${subj7}`, '', `${subj5}`, `${subj9}`] }
			],

			schedG09: [
				{ time: '06:45 - 07:15', data: ['', '', '', '', ''] },
				{ time: '07:15 - 08:15', data: [`${subj8}`, `${subj10}`, '', `${subj1}`, `${subj9}`] },
				{
					time: '08:15 - 09:15',
					data: [`${subj9}`, `${subj11}`, `${subj10}`, `${subj2}`, `${subj1}`]
				},
				{
					time: '09:15 - 10:15',
					data: [`${subj1}`, `${subj12}`, `${subj11}`, `${subj3}`, `${subj2}`]
				...
				{
					time: '03:30 - 04:30',
					data: [`${subj6}`, `${subj5}`, `${subj4}`, `${subj8}`, `${subj7}`]
				},
				{ time: '04:30 - 05:30', data: [`${subj7}`, '', `${subj5}`, `${subj9}`, `${subj8}`] }
			],

			schedG10: [
				{ time: '06:45 - 07:15', data: ['', '', '', '', ''] },
				{ time: '07:15 - 08:15', data: [`${subj10}`, '', `${subj1}`, `${subj9}`, `${subj8}`] },
				{
					time: '08:15 - 09:15',
					data: [`${subj11}`, `${subj10}`, `${subj2}`, `${subj1}`, `${subj9}`]
				},
				{
					time: '09:15 - 10:15',
					data: [`${subj12}`, `${subj11}`, `${subj3}`, `${subj2}`, `${subj1}`]
				...
				{
					time: '03:30 - 04:30',
					data: [`${subj5}`, `${subj4}`, `${subj8}`, `${subj7}`, `${subj6}`]
				},
				{ time: '04:30 - 05:30', data: ['', `${subj5}`, `${subj9}`, `${subj8}`, `${subj7}`] }
			],
			...
			schedG11: [
				...
				{
					time: '08:15 - 09:15',
					data: [`${subj10}`, `${subj2}`, `${subj1}`, `${subj9}`, `${subj11}`]
				},
				{
					time: '09:15 - 10:15',
					data: [`${subj11}`, `${subj3}`, `${subj2}`, `${subj1}`, `${subj12}`]
				...
				{
					time: '03:30 - 04:30',
					data: [`${subj4}`, `${subj8}`, `${subj7}`, `${subj6}`, `${subj5}`]
				},
				{ time: '04:30 - 05:30', data: [`${subj5}`, `${subj9}`, `${subj8}`, `${subj7}`, ''] }
			],
			...
			schedG12: [
				...
				{
					time: '07:15 - 08:15',
					data: [`${subj5}`, `${subj4}`, `${subj3}`, `${subj2}`, `${subj4}`]
				},
				{
					time: '08:15 - 09:15',
					data: [`${subj6}`, `${subj5}`, `${subj4}`, `${subj3}`, `${subj2}`]
				...
				{
					time: '09:15 - 10:15',
					data: [`${subj7}`, `${subj6}`, `${subj5}`, `${subj4}`, `${subj10}`]
				},
				{ time: '10:15 - 10:30', data: ['', '', '', '', ''] },
				{
					time: '10:30 - 11:30',
					data: [`${subj8}`, `${subj7}`, `${subj6}`, `${subj5}`, `${subj11}`]
				},
				{
					time: '11:30 - 12:30',
					data: [`${subj9}`, `${subj8}`, `${subj7}`, `${subj10}`, `${subj12}`]
				},
				{ time: '12:30 - 01:15', data: ['', '', '', '', ''] },
				{ time: '01:15 - 02:15', data: [`${subj1}`, `${subj9}`, `${subj8}`, `${subj11}`, ''] },
				{
					time: '02:15 - 03:15',
					data: [`${subj2}`, `${subj1}`, `${subj9}`, `${subj12}`, `${subj3}`]
				},
				{ time: '03:15 - 03:30', data: ['', '', '', '', ''] },
				{ time: '03:30 - 04:30', data: [`${subj3}`, `${subj2}`, `${subj1}`, '', `${subj1}`] },
				{
					time: '04:30 - 05:30',
					data: [`${subj4}`, `${subj3}`, `${subj2}`, `${subj1}`, `${subj5}`]
				}
	...
	let schedules = {
		schedG01: [
			{ time: '06:45 - 07:15', data: ['', '', '', '', ''] },
			{ time: '07:15 - 08:00', data: ['', '', '', '', ''] },
			{ time: '08:00 - 08:45', data: ['A', 'H', 'G', 'J', 'I'] },
			{ time: '08:45 - 09:30', data: ['B', 'A', 'H', 'K', 'J'] },
			{ time: '09:30 - 10:00', data: ['', '', '', '', ''] },
			{ time: '10:00 - 10:45', data: ['C', 'B', 'A', 'L', 'K'] },
			{ time: '10:45 - 11:30', data: ['D', 'C', 'B', 'A', 'L'] },
			{ time: '11:30 - 12:30', data: ['', '', '', '', ''] },
			{ time: '12:30 - 01:15', data: ['E', 'D', 'C', 'B', 'A'] },
			{ time: '01:15 - 02:00', data: ['F', 'E', 'D', 'C', 'B'] },
			{ time: '02:00 - 02:30', data: ['', '', '', '', ''] },
			{ time: '02:30 - 03:15', data: ['G', 'F', 'E', 'D', 'C'] },
			{ time: '03:15 - 04:00', data: ['H', 'G', 'F', 'I', 'D'] },
			{ time: '04:30 - 05:15', data: ['', '', '', '', ''] }
		],
		...
		schedG02: [
			{ time: '06:45 - 07:15', data: ['', '', '', '', ''] },
			{ time: '07:15 - 08:00', data: ['', '', '', '', ''] },
			{ time: '08:00 - 08:45', data: ['H', 'G', 'J', 'I', 'A'] },
			{ time: '08:45 - 09:30', data: ['A', 'H', 'K', 'J', 'B'] },
			{ time: '09:30 - 10:00', data: ['', '', '', '', ''] },
			{ time: '10:00 - 10:45', data: ['B', 'A', 'L', 'K', 'C'] },
			{ time: '10:45 - 11:30', data: ['C', 'B', 'A', 'L', 'D'] },
			{ time: '11:30 - 12:30', data: ['', '', '', '', ''] },
			{ time: '12:30 - 01:15', data: ['D', 'C', 'B', 'A', 'E'] },
			{ time: '01:15 - 02:00', data: ['E', 'D', 'C', 'B', 'F'] },
			{ time: '02:00 - 02:30', data: ['', '', '', '', ''] },
			{ time: '02:30 - 03:15', data: ['F', 'E', 'D', 'C', 'G'] },
			{ time: '03:15 - 04:00', data: ['G', 'F', 'I', 'D', 'H'] },
			{ time: '04:30 - 05:15', data: ['', '', '', '', ''] }
		],
		...
		schedG03: [
			{ time: '06:45 - 07:15', data: ['', '', '', '', ''] },
			{ time: '07:15 - 08:00', data: ['', '', '', '', ''] },
			{ time: '08:00 - 08:45', data: ['G', 'J', 'I', 'A', 'H'] },
			{ time: '08:45 - 09:30', data: ['H', 'K', 'J', 'B', 'A'] },
			{ time: '09:30 - 10:00', data: ['', '', '', '', ''] },
			{ time: '10:00 - 10:45', data: ['A', 'L', 'K', 'C', 'B'] },
			{ time: '10:45 - 11:30', data: ['B', 'A', 'L', 'D', 'C'] },
			{ time: '11:30 - 12:30', data: ['', '', '', '', ''] },
			{ time: '12:30 - 01:15', data: ['C', 'B', 'A', 'E', 'D'] },
			{ time: '01:15 - 02:00', data: ['D', 'C', 'B', 'F', 'E'] },
			{ time: '02:00 - 02:30', data: ['', '', '', '', ''] },
			{ time: '02:30 - 03:15', data: ['E', 'D', 'C', 'G', 'F'] },
			{ time: '03:15 - 04:00', data: ['F', 'I', 'D', 'H', 'G'] },
			{ time: '04:30 - 05:15', data: ['', '', '', '', ''] }
		],
		...
		schedG04: [
			{ time: '06:45 - 07:15', data: ['', '', '', '', ''] },
			{ time: '07:15 - 08:00', data: ['', '', '', '', ''] },
			{ time: '08:00 - 08:45', data: ['J', 'I', 'A', 'H', 'G'] },
			{ time: '08:45 - 09:30', data: ['K', 'J', 'B', 'A', 'H'] },
			{ time: '09:30 - 10:00', data: ['', '', '', '', ''] },
			{ time: '10:00 - 10:45', data: ['L', 'K', 'C', 'B', 'A'] },
			{ time: '10:45 - 11:30', data: ['A', 'L', 'D', 'C', 'B'] },
			{ time: '11:30 - 12:30', data: ['', '', '', '', ''] },
			{ time: '12:30 - 01:15', data: ['B', 'A', 'E', 'D', 'C'] },
			{ time: '01:15 - 02:00', data: ['C', 'B', 'F', 'E', 'D'] },
			{ time: '02:00 - 02:30', data: ['', '', '', '', ''] },
			{ time: '02:30 - 03:15', data: ['D', 'C', 'G', 'F', 'E'] },
			{ time: '03:15 - 04:00', data: ['I', 'D', 'H', 'G', 'F'] },
			{ time: '04:30 - 05:15', data: ['', '', '', '', ''] }
		],
		...
		schedG05: [
			{ time: '06:45 - 07:15', data: ['', '', '', '', ''] },
			{ time: '07:15 - 08:00', data: ['', '', '', '', ''] },
			{ time: '08:00 - 08:45', data: ['I', 'A', 'H', 'G', 'J'] },
			{ time: '08:45 - 09:30', data: ['J', 'B', 'A', 'H', 'K'] },
			{ time: '09:30 - 10:00', data: ['', '', '', '', ''] },
			{ time: '10:00 - 10:45', data: ['K', 'C', 'B', 'A', 'L'] },
			{ time: '10:45 - 11:30', data: ['L', 'D', 'C', 'B', 'A'] },
			{ time: '11:30 - 12:30', data: ['', '', '', '', ''] },
			{ time: '12:30 - 01:15', data: ['A', 'E', 'D', 'C', 'B'] },
			{ time: '01:15 - 02:00', data: ['B', 'F', 'E', 'D', 'C'] },
			{ time: '02:00 - 02:30', data: ['', '', '', '', ''] },
			{ time: '02:30 - 03:15', data: ['C', 'G', 'F', 'E', 'D'] },
			{ time: '03:15 - 04:00', data: ['D', 'H', 'G', 'F', 'I'] },
			{ time: '04:30 - 05:15', data: ['', '', '', '', ''] }
		],
		...
		schedG06: [
			{ time: '06:45 - 07:15', data: ['', '', '', '', ''] },
			{ time: '07:15 - 08:00', data: ['', '', '', '', ''] },
			{ time: '08:00 - 08:45', data: ['D', 'C', 'B', 'D', 'C'] },
			{ time: '08:45 - 09:30', data: ['E', 'D', 'C', 'I', 'D'] },
			{ time: '09:30 - 10:00', data: ['', '', '', '', ''] },
			{ time: '10:00 - 10:45', data: ['F', 'E', 'D', 'J', 'I'] },
			{ time: '10:45 - 11:30', data: ['G', 'F', 'E', 'K', 'J'] },
			{ time: '11:30 - 12:30', data: ['', '', '', '', ''] },
			{ time: '12:30 - 01:15', data: ['H', 'G', 'F', 'L', 'K'] },
			{ time: '01:15 - 02:00', data: ['A', 'H', 'G', 'A', 'L'] },
			{ time: '02:00 - 02:30', data: ['', '', '', '', ''] },
			{ time: '02:30 - 03:15', data: ['B', 'A', 'H', 'B', 'A'] },
			{ time: '03:15 - 04:00', data: ['C', 'B', 'A', 'C', 'B'] },
			{ time: '04:30 - 05:15', data: ['', '', '', '', ''] }
		],

		schedG07: [
			{ time: '06:45 - 07:15', data: ['', '', '', '', ''] },
			{ time: '07:15 - 08:15', data: ['A', 'I', 'H', 'J', ''] },
			{ time: '08:15 - 09:15', data: ['B', 'A', 'I', 'K', 'J'] },
			{ time: '09:15 - 10:15', data: ['C', 'B', 'A', 'L', 'K'] },
			{ time: '10:15 - 10:30', data: ['', '', '', '', ''] },
			{ time: '10:30 - 11:30', data: ['D', 'C', 'B', 'A', 'L'] },
			{ time: '11:30 - 12:30', data: ['E', 'D', 'C', 'B', 'A'] },
			{ time: '12:30 - 01:15', data: ['', '', '', '', ''] },
			{ time: '01:15 - 02:15', data: ['F', 'E', 'D', 'C', 'B'] },
			{ time: '02:15 - 03:15', data: ['G', 'F', 'E', 'D', 'C'] },
			{ time: '03:15 - 03:30', data: ['', '', '', '', ''] },
			{ time: '03:30 - 04:30', data: ['H', 'G', 'F', 'E', 'D'] },
			{ time: '04:30 - 05:30', data: ['I', 'H', 'G', '', 'E'] }
		],

		schedG08: [
			{ time: '06:45 - 07:15', data: ['', '', '', '', ''] },
			{ time: '07:15 - 08:15', data: ['I', 'H', 'J', '', 'A'] },
			{ time: '08:15 - 09:15', data: ['A', 'I', 'K', 'J', 'B'] },
			{ time: '09:15 - 10:15', data: ['B', 'A', 'L', 'K', 'C'] },
			{ time: '10:15 - 10:30', data: ['', '', '', '', ''] },
			{ time: '10:30 - 11:30', data: ['C', 'B', 'A', 'L', 'D'] },
			{ time: '11:30 - 12:30', data: ['D', 'C', 'B', 'A', 'E'] },
			{ time: '12:30 - 01:15', data: ['', '', '', '', ''] },
			{ time: '01:15 - 02:15', data: ['E', 'D', 'C', 'B', 'F'] },
			{ time: '02:15 - 03:15', data: ['F', 'E', 'D', 'C', 'G'] },
			{ time: '03:15 - 03:30', data: ['', '', '', '', ''] },
			{ time: '03:30 - 04:30', data: ['G', 'F', 'E', 'D', 'H'] },
			{ time: '04:30 - 05:30', data: ['H', 'G', '', 'E', 'I'] }
		],

		schedG09: [
			{ time: '06:45 - 07:15', data: ['', '', '', '', ''] },
			{ time: '07:15 - 08:15', data: ['H', 'J', '', 'A', 'I'] },
			{ time: '08:15 - 09:15', data: ['I', 'K', 'J', 'B', 'A'] },
			{ time: '09:15 - 10:15', data: ['A', 'L', 'K', 'C', 'B'] },
			{ time: '10:15 - 10:30', data: ['', '', '', '', ''] },
			{ time: '10:30 - 11:30', data: ['B', 'A', 'L', 'D', 'C'] },
			{ time: '11:30 - 12:30', data: ['C', 'B', 'A', 'E', 'D'] },
			{ time: '12:30 - 01:15', data: ['', '', '', '', ''] },
			{ time: '01:15 - 02:15', data: ['D', 'C', 'B', 'F', 'E'] },
			{ time: '02:15 - 03:15', data: ['E', 'D', 'C', 'G', 'F'] },
			{ time: '03:15 - 03:30', data: ['', '', '', '', ''] },
			{ time: '03:30 - 04:30', data: ['F', 'E', 'D', 'H', 'G'] },
			{ time: '04:30 - 05:30', data: ['G', '', 'E', 'I', 'H'] }
		],

		schedG10: [
			{ time: '06:45 - 07:15', data: ['', '', '', '', ''] },
			{ time: '07:15 - 08:15', data: ['J', '', 'A', 'I', 'H'] },
			{ time: '08:15 - 09:15', data: ['K', 'J', 'B', 'A', 'I'] },
			{ time: '09:15 - 10:15', data: ['L', 'K', 'C', 'B', 'A'] },
			{ time: '10:15 - 10:30', data: ['', '', '', '', ''] },
			{ time: '10:30 - 11:30', data: ['A', 'L', 'D', 'C', 'B'] },
			{ time: '11:30 - 12:30', data: ['B', 'A', 'E', 'D', 'C'] },
			{ time: '12:30 - 01:15', data: ['', '', '', '', ''] },
			{ time: '01:15 - 02:15', data: ['C', 'B', 'F', 'E', 'D'] },
			{ time: '02:15 - 03:15', data: ['D', 'C', 'G', 'F', 'E'] },
			{ time: '03:15 - 03:30', data: ['', '', '', '', ''] },
			{ time: '03:30 - 04:30', data: ['E', 'D', 'H', 'G', 'F'] },
			{ time: '04:30 - 05:30', data: ['', 'E', 'I', 'H', 'G'] }
		],

		schedG11: [
			{ time: '06:45 - 07:15', data: ['', '', '', '', ''] },
			{ time: '07:15 - 08:15', data: ['', 'A', 'I', 'H', 'J'] },
			{ time: '08:15 - 09:15', data: ['J', 'B', 'A', 'I', 'K'] },
			{ time: '09:15 - 10:15', data: ['K', 'C', 'B', 'A', 'L'] },
			{ time: '10:15 - 10:30', data: ['', '', '', '', ''] },
			{ time: '10:30 - 11:30', data: ['L', 'D', 'C', 'B', 'A'] },
			{ time: '11:30 - 12:30', data: ['A', 'E', 'D', 'C', 'B'] },
			{ time: '12:30 - 01:15', data: ['', '', '', '', ''] },
			{ time: '01:15 - 02:15', data: ['B', 'F', 'E', 'D', 'C'] },
			{ time: '02:15 - 03:15', data: ['C', 'G', 'F', 'E', 'D'] },
			{ time: '03:15 - 03:30', data: ['', '', '', '', ''] },
			{ time: '03:30 - 04:30', data: ['D', 'H', 'G', 'F', 'E'] },
			{ time: '04:30 - 05:30', data: ['E', 'I', 'H', 'G', ''] }
		],

		schedG12: [
			{ time: '06:45 - 07:15', data: ['', '', '', '', ''] },
			{ time: '07:15 - 08:15', data: ['E', 'D', 'C', 'B', 'D'] },
			{ time: '08:15 - 09:15', data: ['F', 'E', 'D', 'C', 'B'] },
			{ time: '09:15 - 10:15', data: ['G', 'F', 'E', 'D', 'J'] },
			{ time: '10:15 - 10:30', data: ['', '', '', '', ''] },
			{ time: '10:30 - 11:30', data: ['H', 'G', 'F', 'E', 'K'] },
			{ time: '11:30 - 12:30', data: ['I', 'H', 'G', 'J', 'L'] },
			{ time: '12:30 - 01:15', data: ['', '', '', '', ''] },
			{ time: '01:15 - 02:15', data: ['A', 'I', 'H', 'K', ''] },
			{ time: '02:15 - 03:15', data: ['B', 'A', 'I', 'L', 'C'] },
			{ time: '03:15 - 03:30', data: ['', '', '', '', ''] },
			{ time: '03:30 - 04:30', data: ['C', 'B', 'A', '', 'A'] },
	...
	const modlID = 'B04';
	const modlNM = 'Schedule Management';
...
<div class="flex flex-col w-screen h-screen overflow-x-hidden bg-border">
								...
								<div class="menu-item-collapse">
									<div class="min-h-0">
										...
										<a
											...
											class="menu-item menu-active ml-6">Schedule Management</a>
										<div class="divider my-0" />
										<a
	...
	{#if modlST}
		<div
			class="flex flex-col h-auto w-full pt-20 pb-8 pl-6 lg:pl-80 pr-6 gap-8 bg-white dark:bg-backgroundPrimary">
			<div class="flex flex-col">
				<h1 class="text-xl font-semibold">Section Masterlist</h1>
				<p class="text-xs">Below is the list of all sections.</p>
			</div>
					...
					<div class="dropdown dropdown-hover">
						...
						<div class="dropdown-menu dropdown-menu-right-bottom ml-2">
							<p
								...
								on:click={() => filterSections('Active')}>
								Active
							</p>
							<p
								class="dropdown-item text-sm"
								on:click={() => filterSections('Archived')}>
								Archived
							</p>
							<div class="divider my-0" />
							<p
								class="dropdown-item text-sm"
								on:click={() => filterSections('Clear Filter')}>
								Clear Filter
							</p>
						</div>
					</div>
				...
				<div class="flex flex-row gap-2">
					...
					<div class="pagination">
						...
						<button
							...
							on:click={() => changePage(currentPage + 1)}
							disabled={currentPage === Math.floor(sections.length / 6)}>
							<svg
								width="18"
								height="18"
								viewBox="0 0 20 20"
			...
			<div class="flex w-full">
				<table class="table table-hover table-compact">
					...
					<tbody>
						{#each limitedSections as section (section.sectID)}
							<tr
								on:click={() => {
									if ((isEditing = false)) {
										isSelecting = true;
			...
			<div class="divider my-0" />
			<div class="flex flex-col">
				<h1 class="text-xl font-semibold">Section Information</h1>
				<p class="text-xs">Select a section to load its information.</p>
			</div>
			{#if isSelecting && !isCreating}
				<div class="flex flex-col">
					<h1 class="text-sm font-semibold underline">Section Information</h1>
				</div>
				<div class="form-group flex flex-col lg:flex-row">
					<div class="form-field lg:w-1/2">
						...
						<input
							...
							bind:value={selectedSectionData.sectST}
							readonly />
					</div>
					<div class="form-field lg:w-1/2">
						<label
						...
						<input
							id="sectDP"
							class="input max-w-full"
							bind:value={selectedSectionData.sectDP}
							readonly />
					</div>
				</div>
				<div class="form-group flex flex-col lg:flex-row">
					...
					<div class="form-field lg:w-1/2">
						<label
							for="sectYR"
							class="form-label">Year Level</label>
						<input
							id="sectYR"
							class="input max-w-full"
							bind:value={selectedSectionData.sectYR}
							readonly />
					</div>
					<div class="form-field lg:w-1/2">
						<label
			...
			<div class="flex flex-col">
				...
				<p class="text-xs">Select the subjects that this section has classes on.</p>
			</div>
			<div class="form-field w-full">
				{#each Array.from({ length: 3 }, (_, groupIndex) => groupIndex) as groupIndex}
					<div class="flex flex-col lg:flex-row gap-3">
						{#each Array.from({ length: 4 }, (_, index) => groupIndex * 4 + index + 1) as subjectIndex}
							<div class="flex flex-col w-full gap-2">
								<label
									for="subj{subjectIndex}"
									class="form-label">Subject {subjectIndex}</label>
								<select
									id="subj{subjectIndex}"
									name="subj{subjectIndex}"
									class="select"
									bind:value={selectedSubjects[subjectIndex]}>
									{#each subjects as subject (subject.subjID)}
										{#if subjectIsAvailable(subject.subjNM, subjectIndex) && subject.subjYR === selectedSectionData.sectYR}
											<option value={subject.subjNM}>{subject.subjNM}</option>
										{/if}
									{/each}
								</select>
							</div>
			...
			<div class="flex flex-col">
				<h1 class="text-xl font-semibold">Schedule Table</h1>
				<p class="text-xs">The timetable will be generated based on the above information.</p>
			</div>
			<div class="flex flex-col gap-2">
				...
				<button
					class="btn btn-outline-primary"
					on:click={setSubjects}>Generate Schedule</button>
			</div>
			{#if hasSubjects}
				<div class="flex w-full">
					<table class="table table-hover table-compact">
						...
						<tbody>
							{#each schedules[selectedSchedule] as schedule}
								<tr>
									<td>{schedule.time}</td>
									{#each schedule.data as subjectCode}
										<td>{subjectCode}</td>
									{/each}
								</tr>
							{/each}
